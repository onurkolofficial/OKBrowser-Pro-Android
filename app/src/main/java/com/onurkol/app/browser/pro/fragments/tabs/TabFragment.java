package com.onurkol.app.browser.pro.fragments.tabs;
...
import com.onurkol.app.browser.pro.adapters.tabs.RecentSearchListAdapter;
import com.onurkol.app.browser.pro.adapters.tabs.UserWebCollectionListAdapter;
import com.onurkol.app.browser.pro.controller.FragmentController;
...
import com.onurkol.app.browser.pro.controller.browser.SearchEngineController;
...
import com.onurkol.app.browser.pro.dialogs.tabs.DialogUserCollectionNewPage;
import com.onurkol.app.browser.pro.interfaces.BrowserDataInterface;
import com.onurkol.app.browser.pro.interfaces.tabs.TabInterface;
import com.onurkol.app.browser.pro.libs.JavascriptManager;
import com.onurkol.app.browser.pro.libs.ScreenManager;
import com.onurkol.app.browser.pro.libs.URLChecker;
import com.onurkol.app.browser.pro.menu.webview.ContextMenuAnchor;
import com.onurkol.app.browser.pro.menu.webview.ContextMenuAnchorImage;
import com.onurkol.app.browser.pro.menu.webview.ContextMenuImage;
...
import com.onurkol.app.browser.pro.webview.config.WebViewConfig;
import com.onurkol.app.browser.pro.webview.listeners.DownloadListener;
...
public class TabFragment extends Fragment implements BrowserDataInterface, TabInterface {
    ...
    // Update Collection List: added data in menu.
    ...
    // for Developer Mode
    BottomSheetDialog requestDialog=null, resourceDialog=null;
    @Override
    public void setRequestDialog(BottomSheetDialog dialog) {
    ...
    @Override
    public void setResourceDialog(BottomSheetDialog dialog) {
