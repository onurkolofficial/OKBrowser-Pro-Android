...
import com.onurkol.app.browser.pro.activity.SettingsActivity;
...
public class SettingsAboutFragment extends PreferenceFragmentCompat implements BrowserActionKeys {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        // Get Version Data
        String appPackage=getActivity().getString(R.string.app_package_paid_text)+" -"+BuildConfig.BUILD_TYPE+"/pro";
