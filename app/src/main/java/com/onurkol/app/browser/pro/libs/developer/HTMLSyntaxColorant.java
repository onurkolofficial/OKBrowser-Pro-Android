...
import com.onurkol.app.browser.pro.dialogs.developer.DialogShowHTML;
...
public class HTMLSyntaxColorant {
    private static HTMLSyntaxColorant instance=null;
    ...
    private HTMLSyntaxColorant(Context context){
        // Colors
    ...
    public static synchronized HTMLSyntaxColorant getInstance(Context context){
        if(instance==null)
            instance=new HTMLSyntaxColorant(context);
        return instance;
    }
            ...
            while (m.find()){
                ...
                ClickableSpan clickableSpan=new ClickableSpan() {
                    ...
                    public void onClick(@NonNull View view) {
                        ...
                        // Show Dialog
                        DialogShowHTML.getDialog(view.getContext(), getCode).show();
                    }
                    @Override
