...
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsDayNightActivity;
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsDeveloperActivity;
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsGuiActivity;
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsLanguageActivity;
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsSearchEngineActivity;
import com.onurkol.app.browser.pro.activity.browser.settings.SettingsWebActivity;
import com.onurkol.app.browser.pro.controller.ApplicationResetController;
...
public class SettingsHomeFragment extends PreferenceFragmentCompat {
    Preference preferenceWebSettings, preferenceSearchEngine, prefereneceDayNightMode, prefereneceGUIMode,
            preferenceLanguage, preferenceAboutApp, preferenceResetApp, preferenceDeveloperOptions;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        preferenceDeveloperOptions=findPreference("preferenceDeveloperOptions");
        ...
        preferenceDeveloperOptions.setOnPreferenceClickListener(preference -> {
            ActivityActionAnimator.startActivity(requireActivity(),
                    new Intent(requireActivity(), SettingsDeveloperActivity.class));
            return false;
        });
