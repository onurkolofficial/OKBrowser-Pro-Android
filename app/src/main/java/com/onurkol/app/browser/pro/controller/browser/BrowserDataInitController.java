package com.onurkol.app.browser.pro.controller.browser;
...
import com.onurkol.app.browser.pro.interfaces.PreferencesInterface;
...
public class BrowserDataInitController implements BrowserDataInterface {
    ...
    public void init(){
        ...
        // Developer Mode
        if (!preferenceController.isExist(KEY_DEVELOPER_MODE))
            preferenceController.setPreference(KEY_DEVELOPER_MODE, DEFAULT_DEVELOPER_MODE);
        // Developer Settings
        if (!preferenceController.isExist(KEY_DEVELOPER_VS_LINE_NUMBERS))
            preferenceController.setPreference(KEY_DEVELOPER_VS_LINE_NUMBERS, DEFAULT_DEVELOPER_VS_LINE_NUMBERS);
        if (!preferenceController.isExist(KEY_DEVELOPER_VS_LINE_WRAP))
            preferenceController.setPreference(KEY_DEVELOPER_VS_LINE_WRAP, DEFAULT_DEVELOPER_VS_LINE_WRAP);
        if (!preferenceController.isExist(KEY_DEVELOPER_GN_REFRESH))
            preferenceController.setPreference(KEY_DEVELOPER_GN_REFRESH, DEFAULT_DEVELOPER_GN_REFRESH);
    }
